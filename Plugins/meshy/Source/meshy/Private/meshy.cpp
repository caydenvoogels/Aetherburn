...
void FMeshyModule::StartupModule()
{
    ...
    // Meshy's web app can only detect Unreal while the local bridge is
    // listening. Start it with the editor so users do not have to enable the
    // menu toggle manually after every launch.
